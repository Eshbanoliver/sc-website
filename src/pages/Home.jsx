...
export default function Home({ onOpenConsultation }) {
  ...
  return (
    <div className="space-y-24 sm:space-y-32 overflow-hidden">
      ...
      {/* SERVICES SECTION (CARD STYLE 1: COLORFUL ASYMMETRIC TINTED CARDS) */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          badge="What We Do"
      ...
      {/* HOW IT WORKS (CARD STYLE 4: CONNECTED TIMELINE 01 ───── 02 ───── 03 ───── 04) */}
      <section className="bg-gradient-to-b from-[#093965] via-[#083057] to-[#062644] text-white py-20 sm:py-28 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="mt-20 hidden lg:block relative">
            {/* Connecting Line running across all 4 steps */}
      ...
      {/* WHY STAFF CLICKS (CARD STYLE 2: NUMBER-DRIVEN FEATURE GRID WITH OVERSIZED BACKGROUND NUMBERS) */}
          ...
          <div className="mt-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {whyChooseUsFeatures.map((feat, idx) => {
              ...
              return (
                ...
                >
                  {/* Oversized typography number behind content */}
      ...
      {/* INDUSTRIES PREVIEW (CARD STYLE 3: INTERACTIVE TILES) */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* GLOBAL PRESENCE SECTION (CARD STYLE 5: DARK NAVY INTERNATIONAL PANEL) */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
      ...
      {/* LARGE CTA SECTION (CARD STYLE 6: LARGE PREMIUM GRADIENT PANEL WITH ORANGE GLOW) */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="relative rounded-3xl bg-gradient-to-r from-[#093965] via-[#08345c] to-[#2E8D9F] p-8 sm:p-14 lg:p-16 text-white text-center shadow-2xl overflow-hidden border border-[#2E8D9F]/40">
          {/* Subtle orange glow and abstract circles */}

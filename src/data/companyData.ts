...
export const COMPANY_INFO: CompanyInfo = {
  ...
  operatingHours: "Monday – Saturday: 9:00 AM – 7:00 PM IST / EST & PST Support Available",
  markets: [
    { name: "India", hub: "Ajmer, Rajasthan", note: "Operations & Delivery Center" },
  ...
  stats: [
    { label: "Markets Served", value: "India, USA & Canada", detail: "Global remote collaboration" },
